...
function BidirectionalHorizontalTree(
  data,
  {
    children,
    tree = d3.tree,
  ...
  const svg = d3
    ...
    .attr(
      'style',
      'max-width: 100%; height: auto; font-family: sans-serif; font-size: 14px; background: #fff;'
    );
  ...
  function handleMouseOut() {
    g.selectAll('.link').attr('stroke-opacity', strokeOpacity);
    g.selectAll('.node').attr('fill-opacity', 1);
  }
