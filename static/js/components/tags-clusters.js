            ...
            for (let label in this.state.clusters) {
                ...
                for (let txt_d of this.state.clusters[label]) {
                    ...
                    if (!skip_tag) {
                        ...
                        tag_td = <td className="tag_txt_clusters_td_middle" rowSpan={this.state.clusters[label].length}>
                ...
                tbodies.push(
                    <tbody className="tag_txt_clusters_cluster" key={"label_body" + label}>{rows}</tbody>
                )
            }
            return(
