...
class ROpenAI:
    ...
    def call(self, user_msgs: List[str], system_msgs: Optional[List[str]]=None, temperature: float=0.7, reasoning: Optional[dict]=None, max_tokens: Optional[int] = None) -> str:
        messages = []
